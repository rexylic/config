...
complete -c rumdl -n "__fish_rumdl_using_subcommand check" -l flavor -d 'Markdown flavor to use: standard (also accepts gfm/github/commonmark), mkdocs, mdx, pandoc, quarto, obsidian, kramdown, azure_devops (also accepts azure/ado), myst (also accepts mystmd), hugo (also accepts goldmark), mdg (also accepts markdown_with_gherkin), or gh-aw (preview)' -r -f -a "standard\t''
mkdocs\t''
mdx\t''
pandoc\t''
quarto\t''
...
complete -c rumdl -n "__fish_rumdl_using_subcommand check" -l no-code-block-tools -d 'Skip configured code-block tools while preserving all other configuration'
complete -c rumdl -n "__fish_rumdl_using_subcommand check" -l only-code-block-tools -d 'Run only configured code-block tools, without processing the outer Markdown document'
...
complete -c rumdl -n "__fish_rumdl_using_subcommand check" -l stdin-batch -d 'Read NUL-delimited path/content pairs from stdin'
complete -c rumdl -n "__fish_rumdl_using_subcommand check" -l stdin-batch-closed-world -d 'Resolve links only against documents supplied by --stdin-batch'
...
sarif\t'SARIF 2.1.0 for static analysis tools'
junit\t'JUnit XML for CI test reporters'"
complete -c rumdl -n "__fish_rumdl_using_subcommand fmt" -l flavor -d 'Markdown flavor to use while formatting: standard (also accepts gfm/github/commonmark), mkdocs, mdx, pandoc, quarto, obsidian, kramdown, azure_devops (also accepts azure/ado), myst (also accepts mystmd), hugo (also accepts goldmark), mdg (also accepts markdown_with_gherkin), or gh-aw (preview)' -r -f -a "standard\t''
mkdocs\t''
mdx\t''
pandoc\t''
quarto\t''
...
complete -c rumdl -n "__fish_rumdl_using_subcommand fmt" -l no-code-block-tools -d 'Skip configured code-block tools while preserving all other configuration'
complete -c rumdl -n "__fish_rumdl_using_subcommand fmt" -l only-code-block-tools -d 'Run only configured code-block tools, without processing the outer Markdown document'
